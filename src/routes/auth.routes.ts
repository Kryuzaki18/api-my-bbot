...
const SigninSchema = {
  description:
    "Proves Binance credentials by fetching account details and issues a secure stateless JWT session token.",
  tags: ["Authentication"],
  body: Type.Object({
...
const SignoutSchema = {
  description:
    "Endpoint to instruct the frontend to terminate the session token.",
  tags: ["Authentication"],
  response: {
    200: Type.Object({
      message: Type.String(),
